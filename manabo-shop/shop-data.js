...
{id:'npc_sakita',name:'サキタン・ユ',emoji:'📊',desc:'虚勢を張る生真面目な勉強家。本当は甘えたい末っ子気質。優柔不断で長く悩む。語尾に「ゆ」がつく。',likes:['本','道具','家具'],likeRarity:[1,2],budget:[300,10000],activeHours:[22,24],activeDays:[0,6],msg:['「…これ、合理的に考えると買いなゆ。いや待って、ほんとに必要？…必要ゆ。買う。」','「（5分後）やっぱり買うゆ。機能性で選んだんだから間違ってないゆ。かわいいとかじゃないゆ。」','「子供の教育のために買うゆ。自分のためじゃないゆ。…ちょっとだけ自分のためかもゆ。」']},
...
{id:'npc_toshiko',name:'トシコポッケ',emoji:'🐕',desc:'犬連れのお金持ちのお婆さん。高級品と孫へのプレゼントをよく買う。まとめ買いする。',likes:['アクセサリー','家具','お菓子','ぬいぐるみ'],likeRarity:[2,3,4],budget:[3000,99999],msg:['「孫が喜ぶわ！これもあれも全部買いましょう！」','「お婆さんの目は誤魔化せません。これは本物の良品よ。」','「ポッケ（犬）も喜んでるわ！決定！まとめていただくわよ！」']},
];
