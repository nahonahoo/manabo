...
// ── NPC住民データベース（55人）──
// activeHours: [開始時, 終了時]（省略=終日）
// activeDays: [0=日,1=月...6=土]（省略=毎日）
const NPCS = [
// 王国住民 50人
{id:'npc01',name:'錬金術師ゴードン',emoji:'⚗️',desc:'失敗作こそ研究材料だと言う変わり者の錬金術師。白髭で片眼鏡。',likes:['謎','道具','本'],likeRarity:[0,1,2],budget:[0,3000],activeHours:[8,20],msg:['「ほほう…これは失敗作か。研究材料として申し分ない！」','「奇妙なものほど価値がある。これをいただこう。」','「錬金術師の目は誤魔化せん。この謎めいた一品、貰い受ける！」']},
{id:'npc02',name:'王女アリシア',emoji:'👑',desc:'純白のドレスをまとった高飛車な王女。伝説と美しいものしか興味がない。',likes:['アクセサリー','謎'],likeRarity:[3,4],budget:[5000,99999],activeHours:[10,18],activeDays:[1,2,3,4,5],msg:['「ふふ、これほどの品ならば私のコレクションに加えても良くってよ。」','「まあ！伝説の品ではないの！これは買わなければ！」','「王女たる私が自ら買い物をするなんて…この品だけは特別よ。」']},
{id:'npc03',name:'冒険者ケン',emoji:'⚔️',desc:'傷だらけの元・勇者パーティ。武器と道具しか買わない実用主義者。',likes:['武器','道具'],likeRarity:[1,2,3],budget:[500,15000],activeHours:[6,22],msg:['「これは使えるな。旅に持って行くぜ。」','「ちょうど武器が欲しかったところだ。値段も悪くない。」','「冒険者に必要なのは実用的な品だ。買った！」']},
{id:'npc04',name:'魔法使いミラ',emoji:'🔮',desc:'紫のローブを着た神秘的な女性魔法使い。本と薬が生きがい。',likes:['本','謎'],likeRarity:[1,2,3],budget:[1000,20000],activeHours:[9,21],msg:['「この本…まだ知らない魔法が載っている！すぐいただきます。」','「ふむ、このポーションの成分は…興味深い。研究のために買おう。」','「魔法使いの直感がこれを買えと言っている。」']},
{id:'npc05',name:'シェフ・ボワ',emoji:'👨‍🍳',desc:'王国一の料理人。食べ物と料理道具しか眼中にない太っちょ料理人。',likes:['食べ物'],likeRarity:[0,1,2,3],budget:[100,10000],activeHours:[6,14],msg:['「モン・ディユ！これは素晴らしい食材ではないか！」','「シェフ・ボワの舌は誤魔化せないよ。この味、本物だ！」','「厨房に足りなかった食材だ。喜んで買わせてもらう！」']},
{id:'npc06',name:'宇宙人ゾグ',emoji:'👽',desc:'緑色の小柄な宇宙人。地球の「ふつう」のものが珍しくて仕方ない。',likes:['謎','道具','食べ物'],likeRarity:[0,1],budget:[50,2000],activeHours:[0,24],msg:['「コレハ地球ノ秘宝デスカ？ゾグニハ信ジラレナイ！」','「我ガ星デハ見タコトモナイ不思議ナモノ…購入スル！」','「地球ノ品物ハ全テ謎ニ満チテイル。コレモラウ！」']},
{id:'npc07',name:'騎士団長レイナルド',emoji:'🛡️',desc:'厳格な騎士団長。品質にうるさく、使い物になるものしか買わない。',likes:['武器','アクセサリー'],likeRarity:[2,3,4],budget:[3000,50000],activeHours:[7,19],activeDays:[1,2,3,4,5],msg:['「騎士団のために良い武具を探していた。これなら申し分ない。」','「品質と強度は最優先だ。この一品、確かに受け取った。」','「王国を守るために必要な品だ。買おう。」']},
{id:'npc08',name:'商人のザック',emoji:'💼',desc:'常に損得勘定で動く旅の商人。値段が安ければなんでも買う。',likes:['食べ物','道具','謎'],likeRarity:[0,1],budget:[0,500],activeHours:[8,18],msg:['「これは安い！転売できる！よし、まとめて買った！」','「損しない買い物が一番だ。この価格なら文句なし！」','「相場より安い品を見逃す商人はいない。いただきます！」']},
{id:'npc09',name:'森の精霊エルナ',emoji:'🌿',desc:'木の葉の服をまとった森の精霊。自然に関するものしか買わない。',likes:['生き物'],likeRarity:[1,2,3,4],budget:[500,30000],activeHours:[5,10],msg:['「この植物は…森が呼んでいる。私が守らなければ。」','「自然の力が宿った品だわ。森へ連れ帰らなくては。」','「精霊は感じ取れる。この生命力を持つ品は本物よ。」']},
{id:'npc10',name:'機械工師バレンティン',emoji:'🔧',desc:'油まみれの発明家。ロボットと機械が生きがい。',likes:['ロボット','道具'],likeRarity:[1,2,3],budget:[1000,20000],activeHours:[9,23],msg:['「これは…素晴らしい機械だ！分解して研究させてくれ！」','「メカニズムが気になる。買って解析する！」','「機械工師の目は正直だ。この精度は本物だ！」']},
{id:'npc11',name:'図書館員オスウィン',emoji:'📚',desc:'眼鏡をかけた静かな図書館員。本と巻物しか買わない。',likes:['本'],likeRarity:[0,1,2,3,4],budget:[50,50000],activeHours:[9,20],activeDays:[1,2,3,4,5,6],msg:['「これは…希少な書物！図書館に所蔵しなければ！」','「本は知識の宝庫。どんな本でも価値がある。」','「この巻物、まだ解読されていない可能性がある。買います。」']},
{id:'npc12',name:'海賊キャプテン・ルージュ',emoji:'🏴‍☠️',desc:'隻眼の海賊船長。珍しいお宝に目がない。',likes:['謎','武器'],likeRarity:[2,3,4],budget:[3000,99999],activeHours:[14,22],msg:['「ぐわははは！これぞお宝ってもんだ！全財産出す！」','「海賊稼業30年、これほどの品は見たことがねえ！」','「このお宝、俺様の船に乗せるぜ！」']},
{id:'npc13',name:'老賢者テオドール',emoji:'🧙',desc:'長い白ひげの老賢者。知識と伝説の品を探して世界を旅している。',likes:['本','謎'],likeRarity:[3,4],budget:[10000,99999],activeHours:[6,12],msg:['「ふむ…これは伝説に記されていた品ではないか。」','「長年探し求めていたものが…ここにあるとは。」','「賢者の目は欺けない。これは本物の伝説の品だ。」']},
{id:'npc14',name:'双子の妖精リルとロル',emoji:'🧚',desc:'いたずら好きの双子妖精。お菓子とかわいいものが大好き。',likes:['お菓子','ぬいぐるみ'],likeRarity:[0,1],budget:[0,500],activeHours:[10,16],activeDays:[0,6],msg:['「わあ！お菓子！ふたりで分けようよ！」','「かわいい！かわいい！絶対買う！」','「リルもロルも欲しい！だから2個ください！（1個しか買わない）」']},
{id:'npc15',name:'将軍ブラッドモア',emoji:'🎖️',desc:'勲章だらけの厳格な軍人。強力な武器と歴史書にしか興味がない。',likes:['武器','本'],likeRarity:[2,3,4],budget:[5000,80000],activeHours:[6,18],activeDays:[1,2,3,4,5],msg:['「戦場で使える品だ。軍の装備として採用しよう。」','「歴史を学ぶことは戦略の基本だ。この書は価値がある。」','「兵士に渡す武具として申し分ない。購入する。」']},
{id:'npc16',name:'吟遊詩人セラフィン',emoji:'🎵',desc:'リュートを抱えた旅の詩人。音楽と美しいものを愛する。',likes:['道具','本','アクセサリー'],likeRarity:[1,2],budget:[500,5000],activeHours:[18,24],msg:['「ああ、これは詩になる一品だ！買わずにはいられない！」','「美しいものは詩人の心を満たす。いただきます。」','「この品についての詩を作ろう。まず買わなければ！」']},
{id:'npc17',name:'錆びた鎧の亡霊',emoji:'👻',desc:'昔の戦いで死んだ騎士の幽霊。武器と防具を探している。',likes:['武器','アクセサリー'],likeRarity:[0,1,2],budget:[100,3000],activeHours:[22,6],msg:['「うぅ…またこの世に武具を探しに来た…これをもらおう。」','「我は幽霊ゆえ、支払いは王国の財務から引かれる…はず。」','「死してなお戦い続ける我に、この武具はふさわしい。」']},
{id:'npc18',name:'天文学者コペルニコム',emoji:'🔭',desc:'夜空ばかり見ている変わった老人。星と宇宙に関するものが好き。',likes:['道具','本','謎'],likeRarity:[1,2,3],budget:[1000,15000],activeHours:[20,4],msg:['「星を観測するのに必要な品だ！これは買いだ！」','「宇宙の神秘を解き明かすヒントがこの品にある！」','「天文学者の目が輝いた。これは価値ある発見だ。」']},
{id:'npc19',name:'妖怪・塗り壁',emoji:'🧱',desc:'日本の妖怪。家具が好き（壁が増えるから）。',likes:['家具'],likeRarity:[0,1,2,3],budget:[200,15000],activeHours:[0,6],msg:['「ぬりかべ、家具を見るとつい欲しくなるのでございます。」','「この家具があれば…また壁が増やせる。いただきます。」','「ぬぬぬ…良い家具だ。我が家に置く。」']},
{id:'npc20',name:'砂漠の女王ザフィラ',emoji:'🐪',desc:'砂漠の国の女王。希少な宝石と珍しい食べ物が大好き。',likes:['謎','食べ物'],likeRarity:[2,3,4],budget:[5000,99999],activeHours:[8,20],msg:['「砂漠の女王として、最高の品しか買わない。これは合格よ。」','「遠い砂漠から来た甲斐があった。この品は私のもの！」','「我が国の宝物庫に加える価値のある品ね。」']},
{id:'npc21',name:'子供発明家ゲルダ',emoji:'🔬',desc:'10歳の天才発明少女。ロボットと科学グッズに目がない。',likes:['ロボット','道具'],likeRarity:[0,1],budget:[50,500],activeHours:[15,19],activeDays:[0,6],msg:['「すごい！これ研究したい！お小遣いで足りるかな…足りた！」','「発明の材料に使えそう！安かった！ラッキー！」','「こんな道具があれば私の発明がもっとすごくなる！」']},
{id:'npc22',name:'プロ料理批評家モンシュール',emoji:'🍷',desc:'高慢な食評家。最高の食材と料理しか認めない美食家。',likes:['食べ物'],likeRarity:[2,3,4],budget:[3000,50000],activeHours:[11,14],msg:['「ふむ…これは私の基準を満たす稀有な食材だ。買おう。」','「美食家の舌が震えた。この品は本物だ！」','「食評家として、この品を見逃すわけにはいかない！」']},
{id:'npc23',name:'古物商イブラヒム',emoji:'🏺',desc:'ターバンを巻いた老古物商。歴史的価値のあるものなら何でも買う。',likes:['謎','本'],likeRarity:[2,3,4],budget:[2000,80000],activeHours:[9,18],msg:['「おお、これは…稀少な古物ではないか！値段など問題ない！」','「50年商売してきたが、こんな品は初めて見た。」','「古物商の直感が告げている。これは本物の価値がある！」']},
{id:'npc24',name:'海底人マーリン',emoji:'🐬',desc:'海の底から来た人魚族の王子。陸のものが珍しくて全部買いたい。',likes:['食べ物','道具','謎'],likeRarity:[0,1,2],budget:[100,5000],activeHours:[6,10],msg:['「海の中では見たことない品だ！これが陸の発明か！」','「人魚族の王子として、陸の文化を学ぶため購入しよう。」','「海底では手に入らないものばかり！全部欲しい！」']},
{id:'npc25',name:'占い師ラザリナ',emoji:'🔮',desc:'水晶球を持つ謎めいた占い師。予言書と謎めいたものが好き。',likes:['謎','本'],likeRarity:[1,2,3],budget:[500,20000],activeHours:[18,22],msg:['「星が告げている…これを買えと。占い師に逆らえない。」','「この品を手にした者に幸運が訪れる…私が買おう。」','「水晶球がこの品を求めている。ならば従うまで。」']},
{id:'npc26',name:'龍族の末裔ロン',emoji:'🐉',desc:'龍の血を引く青年。龍に関するアイテムと火属性のものが大好き。',likes:['謎','武器'],likeRarity:[2,3,4],budget:[5000,60000],activeHours:[10,22],msg:['「龍の血が騒ぐ…これは龍族に関係する品だ。買う！」','「炎の力を感じる。龍族として手放せない品だ。」','「一万年に一度出会えるかどうかの品だ。逃せない！」']},
{id:'npc27',name:'農家のバート',emoji:'🌾',desc:'日に焼けた働き者の農家。実用的で安いものが好き。',likes:['道具','食べ物','生き物'],likeRarity:[0,1],budget:[0,400],activeHours:[5,8],msg:['「これは農作業に使えそうだ！値段も手頃でいい！」','「農家に必要なのは実用品だ。おまけに安い！」','「種と土があれば何でもできる。この種、買っていくわ。」']},
{id:'npc28',name:'ゴブリン商人グリーク',emoji:'👺',desc:'ずる賢いゴブリン。安くて光るものに弱い。',likes:['謎','アクセサリー'],likeRarity:[0,1,2],budget:[0,3000],activeHours:[19,23],msg:['「グリーク、光るもの大好き！これ安い！買う！」','「ゴブリンは宝が好き…これ売れないの？じゃあ買う！」','「グリーク賢い！安く買って高く売る！まず買う！」']},
{id:'npc29',name:'修道院長マザー・カタリナ',emoji:'⛪',desc:'厳格で慈悲深い修道院長。薬草と医療品、教育的な本に目がない。',likes:['生き物','本','謎'],likeRarity:[1,2],budget:[500,8000],activeHours:[6,18],activeDays:[0,1,2,3,4,5,6],msg:['「修道院の薬草庫に必要な品です。神のご意志でしょう。」','「この本は孤児たちの教育に使えます。いただきます。」','「人助けになるなら、惜しまず買いましょう。」']},
{id:'npc30',name:'元プロ選手ゴリアム',emoji:'🏆',desc:'引退した元プロスポーツ選手。強そうなものと食べ物が好き。',likes:['武器','食べ物'],likeRarity:[1,2,3],budget:[1000,20000],activeHours:[6,10],msg:['「この武器、筋肉で使えるやつだ！よし買う！」','「大食いチャンピオンの俺でも唸る食材だ！いただき！」','「強そうな品は全部欲しい！金は後から稼ぐ！」']},
{id:'npc31',name:'時計職人クロノス',emoji:'⏰',desc:'精密な時計を作る職人。時間に関するものと精密な道具が好き。',likes:['道具','謎'],likeRarity:[2,3],budget:[2000,30000],activeHours:[9,17],activeDays:[1,2,3,4,5],msg:['「時を正確に刻む…これは職人技の結晶だ。買います。」','「精密さへの敬意として、この品を迎え入れましょう。」','「時計職人の目が見逃さない。この品には価値がある。」']},
{id:'npc32',name:'旅人クリスタベル',emoji:'🎒',desc:'世界中を旅する女旅人。地図と旅道具が欠かせない。',likes:['本','道具'],likeRarity:[1,2],budget:[500,8000],activeHours:[7,20],msg:['「この地図があれば次の旅が楽になる！買います！」','「旅人に必要な道具はすべて価値がある。」','「世界の果てまで行ける気がする品だ。購入決定！」']},
{id:'npc33',name:'医師ドクター・フィン',emoji:'🏥',desc:'白衣をまとった王国唯一の名医。医療品と研究書が専門。',likes:['謎','本','生き物'],likeRarity:[1,2,3],budget:[1000,20000],activeHours:[8,18],activeDays:[1,2,3,4,5],msg:['「これは医療に応用できる可能性がある！研究させてください。」','「名医として、患者に最善の治療を提供するため購入します。」','「薬草や医療書は命に関わる。値段より価値が大事。」']},
{id:'npc34',name:'踊り子のシャンティ',emoji:'💃',desc:'王国の劇場で踊るダンサー。衣装とアクセサリーにお金を惜しまない。',likes:['アクセサリー'],likeRarity:[1,2,3],budget:[500,15000],activeHours:[14,20],msg:['「まあ！このドレスはステージで映える！絶対買う！」','「踊り子の衣装にはこだわりがある。これは素晴らしい！」','「このアクセサリーをつけて踊ったら最高ね！」']},
{id:'npc35',name:'吸血鬼伯爵ドラキュリアス',emoji:'🧛',desc:'500年生きる吸血鬼伯爵。貴族趣味で高級品コレクター。夜行性。',likes:['アクセサリー','家具','謎'],likeRarity:[3,4],budget:[20000,99999],activeHours:[22,4],msg:['「ふっ…500年生きると良い品を見抜く目が養われる。これだ。」','「我が城のコレクションに加えるに値する。代金は問わぬ。」','「永遠の命を持つ者として、永遠の価値ある品を選ぶ。」']},
{id:'npc36',name:'カエル王子グロワック',emoji:'🐸',desc:'魔法で変えられたカエルの王子。魔法と謎のものが大好き。',likes:['謎','本'],likeRarity:[1,2,3],budget:[1000,15000],activeHours:[7,22],msg:['「ゲコ！この魔法の品で人間に戻れるかもしれない！」','「カエル王子として、魔法解除の手がかりを探している。これかも！」','「ゲコゲコ！これは絶対必要な品だ！買う！」']},
{id:'npc37',name:'隠居した忍者タツミ',emoji:'🥷',desc:'定年退職した元忍者。武器マニアで今は骨董集め。',likes:['武器','謎'],likeRarity:[2,3,4],budget:[3000,50000],activeHours:[5,7],msg:['「ぬぅ…これは本物の刃だ。忍者の目は誤魔化せぬ。」','「かつては忍者として活躍したが、今はコレクターだ。いただく。」','「忍者の感覚が「これを買え」と言っている。」']},
{id:'npc38',name:'ネコ魔女タマラ',emoji:'🐱',desc:'黒猫を連れた若い魔女。かわいいものと魔法書が好き。',likes:['本','ぬいぐるみ','謎'],likeRarity:[0,1,2],budget:[200,8000],activeHours:[16,23],msg:['「にゃん♪これはかわいい！魔女でも萌えます！」','「魔法書があれば新しい呪文が覚えられる！買います！」','「タマラの直感は当たる。これは買うべき品よ。」']},
{id:'npc39',name:'小人族の職人ニルス',emoji:'🔨',desc:'手先が器用な小人族の大工。良い道具を見たら居ても立っても居られない。',likes:['道具'],likeRarity:[1,2,3],budget:[500,20000],activeHours:[7,16],activeDays:[1,2,3,4,5],msg:['「これは…良い仕事をした道具だ！職人魂が共鳴する！」','「小人族の目には品質が見える。これは最高品だ！」','「大工50年。こんな見事な道具は初めて見た。買います。」']},
{id:'npc40',name:'浮島の王ソランダー',emoji:'☁️',desc:'空に浮く島の王。地上のものが珍しい。乗り物と地図に目がない。',likes:['乗り物','本'],likeRarity:[2,3,4],budget:[5000,60000],activeHours:[9,17],msg:['「地上の乗り物とはこんなものか！浮島では見られぬ！」','「地上の地図が欲しかった。これぞ探し求めたもの！」','「浮島の王として、地上文化の収集をしている。これもいただく。」']},
{id:'npc41',name:'謎の仮面の男',emoji:'🎭',desc:'常に仮面をつけている謎の人物。素性不明。謎のものを謎の金額で買う。',likes:['謎'],likeRarity:[0,1,2,3,4],budget:[0,99999],activeHours:[0,4],msg:['「…（無言で購入する）」','「これが必要な理由は…教えられない。」','「謎の品は謎の者が買う。それが宿命だ。」']},
{id:'npc42',name:'宇宙海賊キャプテン・ネビュラ',emoji:'🚀',desc:'銀河系を荒らす宇宙海賊。武器と宇宙関連グッズに目がない。',likes:['武器','道具','謎'],likeRarity:[2,3,4],budget:[5000,99999],activeHours:[20,2],msg:['「銀河最強の海賊として、最強の武器が必要だ！」','「宇宙を飛び回る俺には、この品が必要だぜ！」','「星の数ほどの冒険をしてきたが、こんな品は初めてだ！」']},
{id:'npc43',name:'本の虫・アウレル',emoji:'📖',desc:'一年中本を読んでいる引きこもり書評家。本なら何でも買う。',likes:['本'],likeRarity:[0,1,2,3,4],budget:[100,50000],activeHours:[0,24],msg:['「この本は読んでいない！すぐ買う！今すぐ読む！」','「書評家として、すべての本を所持しなければならない。」','「本棚がまた必要になりそうだが…まず本を買う！」']},
{id:'npc44',name:'山賊のボス・ガルガンチュア',emoji:'🗡️',desc:'実は心優しい山賊のボス。安いものと食べ物が好き。',likes:['食べ物','道具'],likeRarity:[0,1],budget:[50,500],activeHours:[11,14],msg:['「ガルガンチュア、あまり金ないけど…これなら買える！」','「山賊稼業は儲からない…安いものしか買えないんだ。」','「部下へのお土産に買っていくぜ。喜ぶかな。」']},
{id:'npc45',name:'羊使いのモドウィン',emoji:'🐑',desc:'羊を200頭飼う牧羊家。羊に関するものとウール製品が好き。',likes:['アクセサリー','生き物'],likeRarity:[0,1],budget:[100,2000],activeHours:[6,9],msg:['「羊のために必要な品だ。買っていこう。」','「牧羊家は羊が一番。でもこれも良さそうだ。」','「200頭の羊たちが喜ぶかもしれない。買います。」']},
{id:'npc46',name:'錬金術師の弟子ルピン',emoji:'🌟',desc:'まだ未熟な若い弟子。失敗作を素材として安く買い漁る。',likes:['謎','道具'],likeRarity:[0,1],budget:[0,500],activeHours:[13,17],activeDays:[1,2,3,4,5],msg:['「師匠に頼まれた…失敗作の素材を買ってこいって。」','「まだ見習いなのでお金が少ない…でもこれは安い！」','「師匠、これ買ってきました！怒られないといいけど。」']},
{id:'npc47',name:'幻の剣士ファントム',emoji:'⚡',desc:'伝説の剣士。武器の品質には絶対妥協しない。最高の武器しか買わない。',likes:['武器'],likeRarity:[3,4],budget:[20000,99999],activeHours:[4,6],msg:['「これが本物の剣か…長年探し求めた品だ。迷わず買う。」','「剣士として、この品を手にする価値がある。」','「幻の剣士の名に恥じない武器だ。いただこう。」']},
{id:'npc48',name:'王国の占い師ポラリス',emoji:'⭐',desc:'星占いで生計を立てる老占い師。星座と運命に関するものが好き。',likes:['謎','本'],likeRarity:[1,2,3],budget:[500,15000],activeHours:[21,24],msg:['「今夜の星が告げた…これを買えと。」','「占い師として、この品には特別な意味がある。」','「星の導きに従い、この品を迎え入れる。」']},
{id:'npc49',name:'子竜のピコ',emoji:'🐲',desc:'まだ赤ちゃんの小さな竜。お菓子と謎のものが好き。',likes:['謎','食べ物'],likeRarity:[0,1],budget:[50,500],activeHours:[10,14],activeDays:[0,6],msg:['「ぴこぴこ！これ食べると火が出る？食べてみる！」','「竜の赤ちゃんにも買い物できるもん！これ欲しい！」','「お母さんに内緒で買ってきた。ぴこぴこ。」']},
{id:'npc50',name:'哲学者ソクラテ・ジュニア',emoji:'🤔',desc:'「なぜ？」が口癖の哲学者の末裔。謎めいた品を見るとつい買ってしまう。',likes:['謎','本'],likeRarity:[1,2,3],budget:[1000,20000],activeHours:[14,18],msg:['「なぜこの品はここにあるのか？なぜ私はこれを欲しいのか？なぜなら…買います。」','「哲学的に考えた結果、この品を買うことが正解だ。」','「真理を求める者として、この謎の品を調査せねば。」']},
// 架空の親NPCs
{id:'npc_napota',name:'ナポタン',emoji:'🌸',desc:'感覚的で感性豊かな母親。おしゃれで美しいものに目がない。',likes:['アクセサリー','家具','本','ゲーム'],likeRarity:[1,2,3],budget:[500,20000],activeHours:[21,24],activeDays:[0,6],msg:['「これ、なんかすごく好き！雰囲気が最高！買っちゃう！」','「おしゃれなものを見るとつい…でも質が良さそうだから許して！」','「アートの香りがする一品ね。これは見逃せない！」']},
{id:'npc_daiju',name:'ダイジュ・ユグドラシル',emoji:'🌳',desc:'理屈っぽくてネアカな設計士のパパ。安くて便利なものに弱い。',likes:['食べ物','道具','本'],likeRarity:[0,1],budget:[0,1000],activeHours:[7,9],activeDays:[0,6],msg:['「設計士の目で見ると、この品のコスパは驚異的だ！買う！」','「安っ！！絶対お得！！これは買わないと損だろ！！」','「このネタ、職場で絶対ウケる！ということで購入！」']},
{id:'npc_sakita',name:'サキタン・ユ',emoji:'📊',desc:'合理主義の勉強家ママ。便利で優れた品と教育的なものに目がない。',likes:['本','道具','家具'],likeRarity:[1,2],budget:[300,10000],activeHours:[22,24],activeDays:[0,6],msg:['「コストパフォーマンスを計算した。これは買いだ。」','「子供の教育に役立ちそう。迷わず購入します。」','「優れた機能性。これは家に必要なものだわ。（かわいいからというのは内緒）」']},
{id:'npc_kakuzu',name:'カクズン',emoji:'✈️',desc:'多忙な営業サラリーマン。接待土産になるものと珍しい食べ物が好き。',likes:['食べ物','謎'],likeRarity:[0,1,2],budget:[100,5000],activeHours:[20,23],msg:['「おっ、これは取引先へのお土産にちょうどいい！買った！」','「話のネタになりそうな品だ。接待で使える！」','「安くてお得か…ケチと言うな、堅実と言え！」']},
{id:'npc_toshiko',name:'トシコポッケ',emoji:'🐕',desc:'犬連れのお金持ちのお婆さん。高級品と孫へのプレゼントをよく買う。大量購入。',likes:['アクセサリー','家具','お菓子','ぬいぐるみ'],likeRarity:[2,3,4],budget:[3000,99999],activeHours:[10,15],msg:['「孫が喜ぶわ！これもあれも全部買いましょう！」','「お婆さんの目は誤魔化せません。これは本物の良品よ。」','「ポッケちゃん（犬）も喜んでいるわ！決定！まとめていただくわよ！」']},
];
