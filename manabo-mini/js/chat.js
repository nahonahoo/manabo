...
{"reply":"（まなぼみにの返事、ひらがなメイン）","learn":{"subject":"すうじ/しぜん/せかい/ことば/えいご/にちじょうのどれか","topic":"（みじかいトピック名。漢字は小学2年生までに習うものだけ使い、それ以外はひらがなで書く）","summary":"（かんたんな言葉での要約1文。漢字は小学2年生までに習うものだけ使い、それ以外はひらがなで書く）","misunderstanding":"（かわいいズレた解釈。漢字は小学2年生までに習うものだけ使い、それ以外はひらがなで書く）"} または null}`;
...
【重要】reaction・summary・misunderstanding・questionのすべてで、漢字は小学2年生までに習うものだけ使い、それ以外はひらがなで書く。
JSON形式のみ（コードブロック不要）:
